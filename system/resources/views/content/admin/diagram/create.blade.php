...
<div class="row">
    <div class="col-xl-9 mx-auto">
            ...
            <hr />
            <form action="{{ url('data-manager/diagram') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Persentase Masuk" name="persentase_masuk">
                                </div>
                                <label class="form-label">Target Bea Masuk</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Target Masuk" name="target_masuk">
                                </div>
                                <label class="form-label">Realisasi Bea Masuk</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Realisasi Masuk" name="realisasi_masuk">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Persentase Keluar" name="persentase_keluar">
                                </div>
                                <label class="form-label">Target Bea Keluar</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Target Keluar" name="target_keluar">
                                </div>
                                <label class="form-label">Realisasi bea Keluar</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Realisasi Keluar" name="realisasi_keluar">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Persentase Cukai" name="persentase_cukai">
                                </div>
                                <label class="form-label">Target Cukai</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Target Cukai" name="target_cukai">
                                </div>
                                <label class="form-label">Realisasi Cukai</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Realisasi Cukai" name="realisasi_cukai">
                                </div>
                            </div>
                        </div>
                    </div>
