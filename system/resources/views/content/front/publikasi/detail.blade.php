                    ...
                    <div class="side-bar">
                        ...
                        <div class="widgets-category">
                            ...
                            <ul class="list-category">
                                <li><a href="#"><i class="fa fa-comments" aria-hidden="true"></i> Pengaduan</a></li>
                                <li><a href="#"><i class="fa fa-line-chart" aria-hidden="true"></i>Kurs Pajak </a>
                                </li>
                                <li><a href="#"><i class="fa fa-location-arrow" aria-hidden="true"></i>Tracking Barang Kiriman </a></li>
                                <li><a href="#"><i class="fa fa-barcode" aria-hidden="true"></i>Registasi IMEI </a></li>
