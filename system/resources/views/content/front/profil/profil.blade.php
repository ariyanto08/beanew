                            ...
                            @foreach ($list_profil as $profil)
                                <div class="image-box">
                                    <div class="image">
                                        ...
                                        <hr>
                                        <iframe width="770" height="450" src="{{ url($profil->link) }}"
                    ...
                    <div class="side-bar">
                        <div class="widgets-category">
                            ...
                            <ul class="list-category">
                                <li><a href="#"><i class="fa fa-hand-paper-o" aria-hidden="true">
                                        </i> Pengaduan</a>
                                </li>
                                <li><a href="#"><i class="fa fa-cog" aria-hidden="true"></i> Kurs Pajak </i></a>
                                </li>
                                <li><a href="#"><i class="fa fa-desktop" aria-hidden="true"></i> Tracking Barang
                                        Kiriman </a></li>
                                <li><a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> Registasi IMEI </i>
                                    </a>
                                </li>
                            </ul>
                        </div>
